...
$ppmp_count = count(array_filter($submissions, function($s) { return $s['submission_type'] === 'PPMP'; }));
$lib_count = count(array_filter($submissions, function($s) { return $s['submission_type'] === 'LIB'; }));
$departments_count = count(array_unique(array_column($submissions, 'dept_name')));
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>BudgetTrack - Reports</title>
...
<div class="flex min-h-screen">
    ...
    <nav class="mt-6">
      ...
      <a href="reports_admin.php" class="flex items-center px-6 py-3 text-maroon bg-red-50 border-r-4 border-maroon">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1 flex flex-col">
            ...
            <div class="bg-white shadow-sm border-b border-gray-200 px-6 py-4">
                <div class="flex justify-between items-center">
                    <div>
                        <h1 class="text-2xl font-bold text-maroon">Submission Reports</h1>
        ...
        Logout
            ...
            <div class="flex-1 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm font-medium text-gray-600">PPMP Documents</p>
                                <p class="text-2xl font-bold text-gray-900"><?php echo $ppmp_count; ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm font-medium text-gray-600">LIB Documents</p>
                                <p class="text-2xl font-bold text-gray-900"><?php echo $lib_count; ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-gray-900"><?php echo $departments_count; ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                    <!-- Document Type Chart -->
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4">Document Type Distribution</h3>
                        <canvas id="documentTypeChart" width="400" height="200"></canvas>
                    </div>
                    
                    <!-- Department Submissions Chart -->
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4">Submissions by Department</h3>
                                        ...
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                <?php 
                                                    ...
                                                    echo $submitted_at ? date('M j, Y', $submitted_at) : '—';
                                                ?>
                                            </td>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const documentTypeChart = new Chart(documentTypeCtx, {
                ...
                data: {
                    labels: ['PPMP', 'LIB'],
                    datasets: [{
                        data: [<?php echo $ppmp_count; ?>, <?php echo $lib_count; ?>],
