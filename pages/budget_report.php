...
<head>
    ...
    <title>BudgetTrack - Budget Report</title>
    ...
    <div class="flex">
        ...
        <div id="sidebar" class="fixed left-0 top-0 h-screen bg-white shadow-lg border-r border-gray-200 transition-all duration-300 z-40 overflow-y-auto w-64">
            ...
            <nav class="mt-6">
                ...
                <a href="budget_report.php" class="flex items-center px-6 py-3 text-maroon bg-red-50 border-r-4 border-maroon">
                    <svg class="w-5 h-5 sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1 flex flex-col" style="margin-left: 256px;">
            ...
            <div class="bg-white shadow-sm border-b border-gray-200 px-6 py-4">
                <div class="flex justify-between items-center">
                    <div>
                        <h1 class="text-2xl font-bold text-maroon">Budget Report</h1>
                        <p class="text-gray-600">Generate and view your department's budget reports</p>
                    </div>
            ...
            <div class="flex-1 p-6">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <h2 class="text-xl font-bold text-maroon mb-6">Budget Summary</h2>
                        
                        <?php if ($budget): ?>
                            <div class="space-y-4">
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-600">Total Allocated</span>
                                    <span class="text-lg font-semibold text-green-600"><?php echo $departmentBudget->formatCurrency($budget['total_allocated']); ?></span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-600">Total Utilized</span>
                                    <span class="text-lg font-semibold text-red-600"><?php echo $departmentBudget->formatCurrency($budget['total_utilized']); ?></span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-600">Remaining</span>
                                    <span class="text-lg font-semibold text-yellow-600"><?php echo $departmentBudget->formatCurrency($budget['total_remaining']); ?></span>
                                </div>
                                    ...
                                    <div class="flex justify-between items-center">
                                        ...
                                        <span class="text-lg font-semibold">
                                            ...
                                            if ($budget['total_allocated'] > 0) {
                                                $rate = ($budget['total_utilized'] / $budget['total_allocated']) * 100;
                    ...
                    <!-- Quick Actions Card -->
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <h2 class="text-xl font-bold text-maroon mb-6">Report Actions</h2>
                        
                        <div class="space-y-4">
                            <button onclick="showComingSoon('Generate PDF Report')" class="w-full flex items-center justify-center px-6 py-3 bg-maroon text-white rounded-lg hover:bg-maroon-dark transition-colors">
                                <i class="fas fa-file-pdf mr-3"></i>
                                Generate PDF Report
                            </button>
                            
                            <button onclick="showComingSoon('Export to Excel')" class="w-full flex items-center justify-center px-6 py-3 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors">
                                <i class="fas fa-file-excel mr-3"></i>
                                Export to Excel
                            </button>
                            
                            <button onclick="showComingSoon('Print Report')" class="w-full flex items-center justify-center px-6 py-3 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors">
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-blue-800">Advanced Reporting Features Coming Soon</h3>
                            <div class="mt-2 text-sm text-blue-700">
                                <p>We're working on adding more detailed reporting features including:</p>
                                <ul class="list-disc list-inside mt-2 space-y-1">
                                    <li>Detailed budget breakdowns by category</li>
                                    <li>Monthly and quarterly reports</li>
