...
$budgetSummary = $departmentBudget->getAllBudgets();
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>BudgetTrack - Procurement Reports</title>
    ...
    <div class="flex min-h-screen">
        ...
        <div class="w-64 bg-white shadow-lg border-r border-gray-200 relative">
            ...
            <nav class="mt-6">
                ...
                <a href="proc_reports.php" class="flex items-center px-6 py-3 text-maroon bg-red-50 border-r-4 border-maroon">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1 flex flex-col">
            ...
            <div class="bg-white shadow-sm border-b border-gray-200 px-6 py-4">
                <div class="flex justify-between items-center">
                    <div>
                        <h1 class="text-2xl font-bold text-maroon">Procurement Reports</h1>
            ...
            <div class="flex-1 p-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                    <h2 class="text-xl font-bold text-maroon mb-6">Submission Reports</h2>
                        ...
                        <div class="bg-blue-50 rounded-lg p-4">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-blue-900"><?php echo count($allSubmissions); ?></p>
                                </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-green-900">
                                        <?php 
                                        $approved = array_filter($allSubmissions, function($s) { return $s['status'] === 'approved'; });
                                        echo count($approved);
                                        ?>
                                    </p>
                                </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-yellow-900">
                                        <?php 
                                        $pending = array_filter($allSubmissions, function($s) { return $s['status'] === 'pending'; });
                                        echo count($pending);
                                        ?>
                                    </p>
                                </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-red-900">
                                        <?php 
                                        $rejected = array_filter($allSubmissions, function($s) { return $s['status'] === 'rejected'; });
                                        echo count($rejected);
                                        ?>
                                    </p>
                                </div>
